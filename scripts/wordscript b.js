...
function wordactive(){
	wordtaskbariconhighlight.style.backgroundColor = "blue"
	wordtaskbariconhighlight.style.width = "15px"
}

function wordnotactive(){
	wordtaskbariconhighlight.style.backgroundColor = "grey"
	wordtaskbariconhighlight.style.width = "7.5px"
}
...
wordtaskbaricon.addEventListener("click", ()=>{
	...
	if(wordapp.style.zIndex != zIndex){
		wordactive();
		zIndex = zIndex + 2
		wordapp.style.zIndex = zIndex;
		return;
...
wordmaximize.addEventListener("click", ()=>{
	wordapp.style.borderRadius = "0px"
...
wordmaxmin.addEventListener("click", ()=>{
	wordapp.style.borderRadius = "5px"
	wordapp.style.transition = "all 0.2s ease-in"
